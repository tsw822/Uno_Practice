...
//using Uno_ws.Views;
using Uno_ws.ViewModels;
using Uno_ws.Repository;
using Uno_ws.Repository.Rest;
using Uno_ws.Repository.Sql;
...
namespace Uno_ws
{
...

    {
        ...
        {
            string demoDatabasePath = Package.Current.InstalledLocation.Path + @"/Contoso.db";
            var localFolder = Windows.Storage.ApplicationData.Current.LocalFolder.Path;
            string databasePath = localFolder + @"/Contoso.db";

            //if (File.Exists(demoDatabasePath))
            //{
            //    var dbOptions = new DbContextOptionsBuilder<ContosoContext>().UseSqlite(
            //    "Data Source=" + demoDatabasePath);
            //    Repository = new SqlContosoRepository(dbOptions);
            //}
            //else
            var dir = Directory.EnumerateFiles(localFolder);
